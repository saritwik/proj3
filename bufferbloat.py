...
class BBTopo(Topo):
    ...
    def build(self, n=2):
        ...
        self.addLink(h1, switch, bw=args.bw_host, delay="%sms " % args.delay)
...
def bufferbloat():
    ...
    while True:
        ...
        download_times.append(download_webpage(net))
	sleep(5)
        now = time()
    ...
    download_times = map(float, download_times)
